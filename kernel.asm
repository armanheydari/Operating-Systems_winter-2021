...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 7b 7b 10 80 	movl   $0x80107b7b,(%esp)
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 7f 64 00 00       	call   80106f90 <setupkvm>
...
80100b73:	e8 38 62 00 00       	call   80106db0 <allocuvm>
...
80100ba9:	e8 32 61 00 00       	call   80106ce0 <loaduvm>
...
80100beb:	e8 20 63 00 00       	call   80106f10 <freevm>
  if(ip){
...
80100c32:	e8 79 61 00 00       	call   80106db0 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 d8 63 00 00       	call   80107030 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cc7:	e8 c4 64 00 00       	call   80107190 <copyout>
...
80100ce1:	e8 2a 62 00 00       	call   80106f10 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 58 64 00 00       	call   80107190 <copyout>
...
80100d9d:	e8 ae 5d 00 00       	call   80106b50 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 66 61 00 00       	call   80106f10 <freevm>
  return 0;
...
80103002:	e8 59 2a 00 00       	call   80105a60 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 01 3b 00 00       	call   80106b30 <switchkvm>
  seginit();
8010302f:	e8 6c 3a 00 00       	call   80106aa0 <seginit>
  lapicinit();
...
80103065:	e8 a6 3f 00 00       	call   80107010 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 27 3a 00 00       	call   80106aa0 <seginit>
  picinit();       // disable pic
...
80103088:	e8 d3 2c 00 00       	call   80105d60 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 49 29 00 00       	call   801059e0 <tvinit>
  binit();         // buffer cache
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 cb 59 10 80 	movl   $0x801059cb,0x14(%eax)
  p->context = (struct context*)sp;
...
801039a7:	e8 e4 35 00 00       	call   80106f90 <setupkvm>
...
801039c5:	e8 96 32 00 00       	call   80106c60 <inituvm>
...
80103abf:	e8 8c 30 00 00       	call   80106b50 <switchuvm>
  return 0;
...
80103ada:	e8 d1 32 00 00       	call   80106db0 <allocuvm>
...
80103afa:	e8 e1 33 00 00       	call   80106ee0 <deallocuvm>
...
80103b4c:	e8 0f 35 00 00       	call   80107060 <copyuvm>
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 8a 2e 00 00       	call   80106f10 <freevm>
        release(&ptable.lock);
...
801041f3:	68 7b 7b 10 80       	push   $0x80107b7b
...
801042a4:	b8 20 2d 11 80       	mov    $0x80112d20,%eax
801042a9:	c3                   	ret    
...
801042be:	68 84 78 10 80       	push   $0x80107884
...
80104505:	68 8f 78 10 80       	push   $0x8010788f
8010450a:	e8 81 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 a6 78 10 80       	push   $0x801078a6
...
80104617:	68 ad 78 10 80       	push   $0x801078ad
...
80104670:	68 b5 78 10 80       	push   $0x801078b5
...
80104a70:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
...
80104a98:	68 bd 78 10 80       	push   $0x801078bd
...
80104bf4:	68 58 79 10 80       	push   $0x80107958
...
80104c0c:	68 57 79 10 80       	push   $0x80107957
...
80104c21:	68 4b 79 10 80       	push   $0x8010794b
...
80104c3f:	68 5a 79 10 80       	push   $0x8010795a
80104c44:	e8 47 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c49:	83 ec 0c             	sub    $0xc,%esp
80104c4c:	68 3c 79 10 80       	push   $0x8010793c
...
8010503d:	58                   	pop    %eax
8010503e:	5a                   	pop    %edx
8010503f:	68 58 79 10 80       	push   $0x80107958
...
80105058:	68 57 79 10 80       	push   $0x80107957
...
80105889:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
8010588c:	53                   	push   %ebx
8010588d:	83 ec 40             	sub    $0x40,%esp
	int *size=0, i, j;
80105890:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
	if (argptr(0, (void *)&procs, sizeof(struct proc_info))<0
80105897:	6a 08                	push   $0x8
80105899:	50                   	push   %eax
8010589a:	6a 00                	push   $0x0
8010589c:	e8 0f f1 ff ff       	call   801049b0 <argptr>
801058a1:	83 c4 10             	add    $0x10,%esp
801058a4:	85 c0                	test   %eax,%eax
801058a6:	0f 88 00 01 00 00    	js     801059ac <sys_proc_dump+0x12c>
	    || argptr(1, (void *)&size, sizeof(int)) < 0) {
801058ac:	83 ec 04             	sub    $0x4,%esp
801058af:	8d 45 e0             	lea    -0x20(%ebp),%eax
801058b2:	6a 04                	push   $0x4
801058b4:	50                   	push   %eax
801058b5:	6a 01                	push   $0x1
801058b7:	e8 f4 f0 ff ff       	call   801049b0 <argptr>
801058bc:	83 c4 10             	add    $0x10,%esp
801058bf:	85 c0                	test   %eax,%eax
801058c1:	0f 88 e5 00 00 00    	js     801059ac <sys_proc_dump+0x12c>
		return -1;
	}
	struct ptable *ptab = proc_table();
801058c7:	e8 d4 e9 ff ff       	call   801042a0 <proc_table>
...
801058cc:	83 ec 0c             	sub    $0xc,%esp
	temp = procs;
801058cf:	8b 75 e4             	mov    -0x1c(%ebp),%esi
	acquire(&ptab->lock);
801058d2:	50                   	push   %eax
	process = ptab->proc;
801058d3:	8d 58 34             	lea    0x34(%eax),%ebx
	struct ptable *ptab = proc_table();
801058d6:	89 45 c0             	mov    %eax,-0x40(%ebp)
	
	for(i=0; i<NPROC; i++) {
801058d9:	89 df                	mov    %ebx,%edi
	temp = procs;
801058db:	89 75 c8             	mov    %esi,-0x38(%ebp)
	acquire(&ptab->lock);
801058de:	e8 8d ec ff ff       	call   80104570 <acquire>
801058e3:	83 c4 10             	add    $0x10,%esp
	for(i=0; i<NPROC; i++) {
801058e6:	31 d2                	xor    %edx,%edx
801058e8:	eb 16                	jmp    80105900 <sys_proc_dump+0x80>
801058ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
				procs[j-1].pid = procs[j].pid;
				procs[j].memsize = temp_size;
				procs[j].pid = temp_pid;
			}
		}
		process++;
801058f0:	83 c7 7c             	add    $0x7c,%edi
	for(i=0; i<NPROC; i++) {
801058f3:	83 7d d4 40          	cmpl   $0x40,-0x2c(%ebp)
801058f7:	0f 84 97 00 00 00    	je     80105994 <sys_proc_dump+0x114>
801058fd:	8b 55 d4             	mov    -0x2c(%ebp),%edx
		if(process->state == RUNNING || process->state == RUNNABLE){
80105900:	8d 42 01             	lea    0x1(%edx),%eax
80105903:	89 45 d4             	mov    %eax,-0x2c(%ebp)
80105906:	8b 47 0c             	mov    0xc(%edi),%eax
80105909:	83 e8 03             	sub    $0x3,%eax
8010590c:	83 f8 01             	cmp    $0x1,%eax
8010590f:	77 df                	ja     801058f0 <sys_proc_dump+0x70>
			temp -> memsize = process->sz;
80105911:	8b 07                	mov    (%edi),%eax
80105913:	8b 5d c8             	mov    -0x38(%ebp),%ebx
80105916:	89 43 04             	mov    %eax,0x4(%ebx)
			temp->pid = process->pid;
80105919:	8b 47 10             	mov    0x10(%edi),%eax
			temp++;
8010591c:	83 c3 08             	add    $0x8,%ebx
			temp->pid = process->pid;
8010591f:	89 43 f8             	mov    %eax,-0x8(%ebx)
			(*size)++;
80105922:	8b 45 e0             	mov    -0x20(%ebp),%eax
			temp++;
80105925:	89 5d c8             	mov    %ebx,-0x38(%ebp)
			(*size)++;
80105928:	83 00 01             	addl   $0x1,(%eax)
			if(i==0)
8010592b:	85 d2                	test   %edx,%edx
8010592d:	74 ce                	je     801058fd <sys_proc_dump+0x7d>
			for (j = *size - 1; j>=1;j--)
8010592f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105932:	8b 00                	mov    (%eax),%eax
80105934:	83 e8 01             	sub    $0x1,%eax
80105937:	89 45 cc             	mov    %eax,-0x34(%ebp)
8010593a:	85 c0                	test   %eax,%eax
8010593c:	7e b2                	jle    801058f0 <sys_proc_dump+0x70>
8010593e:	89 7d c4             	mov    %edi,-0x3c(%ebp)
80105941:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
80105948:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010594f:	90                   	nop
				if (procs[j].memsize >= procs[j-1].memsize)
80105950:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105953:	8d 51 f8             	lea    -0x8(%ecx),%edx
80105956:	8d 34 08             	lea    (%eax,%ecx,1),%esi
80105959:	01 d0                	add    %edx,%eax
8010595b:	8b 58 04             	mov    0x4(%eax),%ebx
8010595e:	8b 7e 04             	mov    0x4(%esi),%edi
80105961:	89 5d d0             	mov    %ebx,-0x30(%ebp)
80105964:	39 df                	cmp    %ebx,%edi
80105966:	73 14                	jae    8010597c <sys_proc_dump+0xfc>
				procs[j-1].memsize = procs[j].memsize;
80105968:	89 78 04             	mov    %edi,0x4(%eax)
				procs[j-1].pid = procs[j].pid;
8010596b:	8b 36                	mov    (%esi),%esi
				int temp_pid = procs[j-1].pid;
8010596d:	8b 18                	mov    (%eax),%ebx
				procs[j-1].pid = procs[j].pid;
8010596f:	89 30                	mov    %esi,(%eax)
				procs[j].memsize = temp_size;
80105971:	8b 45 d0             	mov    -0x30(%ebp),%eax
80105974:	03 4d e4             	add    -0x1c(%ebp),%ecx
80105977:	89 41 04             	mov    %eax,0x4(%ecx)
				procs[j].pid = temp_pid;
8010597a:	89 19                	mov    %ebx,(%ecx)
			for (j = *size - 1; j>=1;j--)
8010597c:	83 6d cc 01          	subl   $0x1,-0x34(%ebp)
80105980:	89 d1                	mov    %edx,%ecx
80105982:	75 cc                	jne    80105950 <sys_proc_dump+0xd0>
80105984:	8b 7d c4             	mov    -0x3c(%ebp),%edi
		process++;
80105987:	83 c7 7c             	add    $0x7c,%edi
	for(i=0; i<NPROC; i++) {
8010598a:	83 7d d4 40          	cmpl   $0x40,-0x2c(%ebp)
8010598e:	0f 85 69 ff ff ff    	jne    801058fd <sys_proc_dump+0x7d>
	}
	
	release(&ptab->lock);
80105994:	83 ec 0c             	sub    $0xc,%esp
80105997:	ff 75 c0             	pushl  -0x40(%ebp)
8010599a:	e8 91 ec ff ff       	call   80104630 <release>

	return 0;
8010599f:	83 c4 10             	add    $0x10,%esp
801059a2:	31 c0                	xor    %eax,%eax
}
...
801059b1:	eb f1                	jmp    801059a4 <sys_proc_dump+0x124>
...
801059b4:	06                   	push   %es
  pushl %fs
801059b5:	0f a0                	push   %fs
  pushl %gs
801059b7:	0f a8                	push   %gs
  pushal
801059b9:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801059ba:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801059be:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801059c0:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801059c2:	54                   	push   %esp
  call trap
801059c3:	e8 c8 00 00 00       	call   80105a90 <trap>
  addl $4, %esp
801059c8:	83 c4 04             	add    $0x4,%esp
...
801059cb:	61                   	popa   
  popl %gs
801059cc:	0f a9                	pop    %gs
  popl %fs
801059ce:	0f a1                	pop    %fs
  popl %es
801059d0:	07                   	pop    %es
  popl %ds
801059d1:	1f                   	pop    %ds
...
801059f7:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
801059fe:	08 00 00 8e 
80105a02:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105a09:	80 
80105a0a:	c1 ea 10             	shr    $0x10,%edx
80105a0d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105a14:	80 
  for(i = 0; i < 256; i++)
...
80105a27:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
80105a2e:	00 00 ef 
  initlock(&tickslock, "time");
80105a31:	68 9d 79 10 80       	push   $0x8010799d
80105a36:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a3b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105a41:	c1 e8 10             	shr    $0x10,%eax
80105a44:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
80105a4a:	e8 a1 e9 ff ff       	call   801043f0 <initlock>
}
...
80105a64:	55                   	push   %ebp
  pd[0] = size-1;
80105a65:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105a6a:	89 e5                	mov    %esp,%ebp
80105a6c:	83 ec 10             	sub    $0x10,%esp
80105a6f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a73:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
80105a78:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105a7c:	c1 e8 10             	shr    $0x10,%eax
80105a7f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105a83:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105a86:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105a89:	c9                   	leave  
80105a8a:	c3                   	ret    
...
80105a9a:	83 ec 1c             	sub    $0x1c,%esp
80105a9d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105aa0:	8b 43 30             	mov    0x30(%ebx),%eax
80105aa3:	83 f8 40             	cmp    $0x40,%eax
80105aa6:	0f 84 bc 01 00 00    	je     80105c68 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105aac:	83 e8 20             	sub    $0x20,%eax
80105aaf:	83 f8 1f             	cmp    $0x1f,%eax
80105ab2:	77 08                	ja     80105abc <trap+0x2c>
80105ab4:	3e ff 24 85 44 7a 10 	notrack jmp *-0x7fef85bc(,%eax,4)
80105abb:	80 
    lapiceoi();
    break;
...
80105abc:	e8 9f de ff ff       	call   80103960 <myproc>
80105ac1:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ac4:	85 c0                	test   %eax,%eax
80105ac6:	0f 84 eb 01 00 00    	je     80105cb7 <trap+0x227>
80105acc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105ad0:	0f 84 e1 01 00 00    	je     80105cb7 <trap+0x227>
...
80105ad6:	0f 20 d1             	mov    %cr2,%ecx
80105ad9:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105adc:	e8 5f de ff ff       	call   80103940 <cpuid>
80105ae1:	8b 73 30             	mov    0x30(%ebx),%esi
80105ae4:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105ae7:	8b 43 34             	mov    0x34(%ebx),%eax
80105aea:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105aed:	e8 6e de ff ff       	call   80103960 <myproc>
80105af2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105af5:	e8 66 de ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105afa:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105afd:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105b00:	51                   	push   %ecx
80105b01:	57                   	push   %edi
80105b02:	52                   	push   %edx
80105b03:	ff 75 e4             	pushl  -0x1c(%ebp)
80105b06:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105b07:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105b0a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b0d:	56                   	push   %esi
80105b0e:	ff 70 10             	pushl  0x10(%eax)
80105b11:	68 00 7a 10 80       	push   $0x80107a00
80105b16:	e8 95 ab ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105b1b:	83 c4 20             	add    $0x20,%esp
80105b1e:	e8 3d de ff ff       	call   80103960 <myproc>
80105b23:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105b31:	74 1d                	je     80105b50 <trap+0xc0>
80105b33:	e8 28 de ff ff       	call   80103960 <myproc>
80105b38:	8b 50 24             	mov    0x24(%eax),%edx
80105b3b:	85 d2                	test   %edx,%edx
80105b3d:	74 11                	je     80105b50 <trap+0xc0>
80105b3f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b43:	83 e0 03             	and    $0x3,%eax
80105b46:	66 83 f8 03          	cmp    $0x3,%ax
80105b4a:	0f 84 50 01 00 00    	je     80105ca0 <trap+0x210>
    exit();
...
80105b57:	74 0f                	je     80105b68 <trap+0xd8>
80105b59:	e8 02 de ff ff       	call   80103960 <myproc>
80105b5e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105b62:	0f 84 e8 00 00 00    	je     80105c50 <trap+0x1c0>
...
80105b95:	c3                   	ret    
    ideintr();
80105b96:	e8 45 c6 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105b9b:	e8 20 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ba0:	e8 bb dd ff ff       	call   80103960 <myproc>
80105ba5:	85 c0                	test   %eax,%eax
80105ba7:	75 8a                	jne    80105b33 <trap+0xa3>
80105ba9:	eb a5                	jmp    80105b50 <trap+0xc0>
    if(cpuid() == 0){
80105bab:	e8 90 dd ff ff       	call   80103940 <cpuid>
80105bb0:	85 c0                	test   %eax,%eax
80105bb2:	75 e7                	jne    80105b9b <trap+0x10b>
      acquire(&tickslock);
80105bb4:	83 ec 0c             	sub    $0xc,%esp
80105bb7:	68 60 4c 11 80       	push   $0x80114c60
80105bbc:	e8 af e9 ff ff       	call   80104570 <acquire>
      wakeup(&ticks);
80105bc1:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105bc8:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105bcf:	e8 0c e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105bd4:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105bdb:	e8 50 ea ff ff       	call   80104630 <release>
80105be0:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105be3:	eb b6                	jmp    80105b9b <trap+0x10b>
    kbdintr();
80105be5:	e8 96 cb ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105bea:	e8 d1 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bef:	e8 6c dd ff ff       	call   80103960 <myproc>
80105bf4:	85 c0                	test   %eax,%eax
80105bf6:	0f 85 37 ff ff ff    	jne    80105b33 <trap+0xa3>
80105bfc:	e9 4f ff ff ff       	jmp    80105b50 <trap+0xc0>
    uartintr();
80105c01:	e8 4a 02 00 00       	call   80105e50 <uartintr>
    lapiceoi();
80105c06:	e8 b5 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c0b:	e8 50 dd ff ff       	call   80103960 <myproc>
80105c10:	85 c0                	test   %eax,%eax
80105c12:	0f 85 1b ff ff ff    	jne    80105b33 <trap+0xa3>
80105c18:	e9 33 ff ff ff       	jmp    80105b50 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105c1d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c20:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105c24:	e8 17 dd ff ff       	call   80103940 <cpuid>
80105c29:	57                   	push   %edi
80105c2a:	56                   	push   %esi
80105c2b:	50                   	push   %eax
80105c2c:	68 a8 79 10 80       	push   $0x801079a8
80105c31:	e8 7a aa ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105c36:	e8 85 cc ff ff       	call   801028c0 <lapiceoi>
    break;
80105c3b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c3e:	e8 1d dd ff ff       	call   80103960 <myproc>
80105c43:	85 c0                	test   %eax,%eax
80105c45:	0f 85 e8 fe ff ff    	jne    80105b33 <trap+0xa3>
80105c4b:	e9 00 ff ff ff       	jmp    80105b50 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105c50:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105c54:	0f 85 0e ff ff ff    	jne    80105b68 <trap+0xd8>
    yield();
80105c5a:	e8 71 e2 ff ff       	call   80103ed0 <yield>
80105c5f:	e9 04 ff ff ff       	jmp    80105b68 <trap+0xd8>
80105c64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105c68:	e8 f3 dc ff ff       	call   80103960 <myproc>
80105c6d:	8b 70 24             	mov    0x24(%eax),%esi
80105c70:	85 f6                	test   %esi,%esi
80105c72:	75 3c                	jne    80105cb0 <trap+0x220>
    myproc()->tf = tf;
80105c74:	e8 e7 dc ff ff       	call   80103960 <myproc>
80105c79:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c7c:	e8 cf ed ff ff       	call   80104a50 <syscall>
    if(myproc()->killed)
80105c81:	e8 da dc ff ff       	call   80103960 <myproc>
80105c86:	8b 48 24             	mov    0x24(%eax),%ecx
80105c89:	85 c9                	test   %ecx,%ecx
80105c8b:	0f 84 fd fe ff ff    	je     80105b8e <trap+0xfe>
}
...
80105c97:	5d                   	pop    %ebp
      exit();
80105c98:	e9 f3 e0 ff ff       	jmp    80103d90 <exit>
80105c9d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105ca0:	e8 eb e0 ff ff       	call   80103d90 <exit>
80105ca5:	e9 a6 fe ff ff       	jmp    80105b50 <trap+0xc0>
80105caa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105cb0:	e8 db e0 ff ff       	call   80103d90 <exit>
80105cb5:	eb bd                	jmp    80105c74 <trap+0x1e4>
80105cb7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105cba:	e8 81 dc ff ff       	call   80103940 <cpuid>
...
80105cc8:	68 cc 79 10 80       	push   $0x801079cc
80105ccd:	e8 de a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105cd2:	83 c4 14             	add    $0x14,%esp
80105cd5:	68 a2 79 10 80       	push   $0x801079a2
...
80105ce0:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105ce4:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105ce9:	85 c0                	test   %eax,%eax
80105ceb:	74 1b                	je     80105d08 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105ced:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105cf2:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105cf3:	a8 01                	test   $0x1,%al
80105cf5:	74 11                	je     80105d08 <uartgetc+0x28>
80105cf7:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105cfc:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105cfd:	0f b6 c0             	movzbl %al,%eax
80105d00:	c3                   	ret    
...
80105d35:	e8 a6 cb ff ff       	call   801028e0 <microdelay>
...
80105d65:	31 c9                	xor    %ecx,%ecx
80105d67:	89 c8                	mov    %ecx,%eax
80105d69:	89 e5                	mov    %esp,%ebp
80105d6b:	57                   	push   %edi
80105d6c:	56                   	push   %esi
80105d6d:	53                   	push   %ebx
80105d6e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105d73:	89 da                	mov    %ebx,%edx
80105d75:	83 ec 0c             	sub    $0xc,%esp
80105d78:	ee                   	out    %al,(%dx)
80105d79:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105d7e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105d83:	89 fa                	mov    %edi,%edx
80105d85:	ee                   	out    %al,(%dx)
80105d86:	b8 0c 00 00 00       	mov    $0xc,%eax
80105d8b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d90:	ee                   	out    %al,(%dx)
80105d91:	be f9 03 00 00       	mov    $0x3f9,%esi
80105d96:	89 c8                	mov    %ecx,%eax
80105d98:	89 f2                	mov    %esi,%edx
80105d9a:	ee                   	out    %al,(%dx)
80105d9b:	b8 03 00 00 00       	mov    $0x3,%eax
80105da0:	89 fa                	mov    %edi,%edx
80105da2:	ee                   	out    %al,(%dx)
80105da3:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105da8:	89 c8                	mov    %ecx,%eax
80105daa:	ee                   	out    %al,(%dx)
80105dab:	b8 01 00 00 00       	mov    $0x1,%eax
80105db0:	89 f2                	mov    %esi,%edx
80105db2:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105db3:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105db8:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105db9:	3c ff                	cmp    $0xff,%al
80105dbb:	74 52                	je     80105e0f <uartinit+0xaf>
  uart = 1;
80105dbd:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105dc4:	00 00 00 
80105dc7:	89 da                	mov    %ebx,%edx
80105dc9:	ec                   	in     (%dx),%al
80105dca:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105dcf:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105dd0:	83 ec 08             	sub    $0x8,%esp
80105dd3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105dd8:	bb c4 7a 10 80       	mov    $0x80107ac4,%ebx
  ioapicenable(IRQ_COM1, 0);
80105ddd:	6a 00                	push   $0x0
80105ddf:	6a 04                	push   $0x4
80105de1:	e8 4a c6 ff ff       	call   80102430 <ioapicenable>
80105de6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105de9:	b8 78 00 00 00       	mov    $0x78,%eax
80105dee:	eb 04                	jmp    80105df4 <uartinit+0x94>
...
80105e24:	55                   	push   %ebp
  if(!uart)
80105e25:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
80105e2b:	89 e5                	mov    %esp,%ebp
80105e2d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105e30:	85 d2                	test   %edx,%edx
80105e32:	74 0c                	je     80105e40 <uartputc+0x20>
}
80105e34:	5d                   	pop    %ebp
80105e35:	e9 d6 fe ff ff       	jmp    80105d10 <uartputc.part.0>
...
80105e57:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105e5a:	68 e0 5c 10 80       	push   $0x80105ce0
80105e5f:	e8 fc a9 ff ff       	call   80100860 <consoleintr>
}
...
80105e6b:	6a 00                	push   $0x0
  jmp alltraps
80105e6d:	e9 41 fb ff ff       	jmp    801059b3 <alltraps>
...
80105e72:	6a 00                	push   $0x0
  pushl $1
80105e74:	6a 01                	push   $0x1
  jmp alltraps
80105e76:	e9 38 fb ff ff       	jmp    801059b3 <alltraps>
...
80105e7d:	6a 02                	push   $0x2
  jmp alltraps
80105e7f:	e9 2f fb ff ff       	jmp    801059b3 <alltraps>
...
80105e84:	6a 00                	push   $0x0
  pushl $3
80105e86:	6a 03                	push   $0x3
  jmp alltraps
80105e88:	e9 26 fb ff ff       	jmp    801059b3 <alltraps>
...
80105e8f:	6a 04                	push   $0x4
  jmp alltraps
80105e91:	e9 1d fb ff ff       	jmp    801059b3 <alltraps>
...
80105e96:	6a 00                	push   $0x0
  pushl $5
80105e98:	6a 05                	push   $0x5
  jmp alltraps
80105e9a:	e9 14 fb ff ff       	jmp    801059b3 <alltraps>
...
80105e9f:	6a 00                	push   $0x0
  pushl $6
80105ea1:	6a 06                	push   $0x6
  jmp alltraps
80105ea3:	e9 0b fb ff ff       	jmp    801059b3 <alltraps>
...
80105ea8:	6a 00                	push   $0x0
  pushl $7
80105eaa:	6a 07                	push   $0x7
  jmp alltraps
80105eac:	e9 02 fb ff ff       	jmp    801059b3 <alltraps>

80105eb1 <vector8>:
.globl vector8
vector8:
  pushl $8
80105eb1:	6a 08                	push   $0x8
  jmp alltraps
80105eb3:	e9 fb fa ff ff       	jmp    801059b3 <alltraps>
...
80105eb8:	6a 00                	push   $0x0
  pushl $9
80105eba:	6a 09                	push   $0x9
  jmp alltraps
80105ebc:	e9 f2 fa ff ff       	jmp    801059b3 <alltraps>

80105ec1 <vector10>:
.globl vector10
vector10:
  pushl $10
80105ec1:	6a 0a                	push   $0xa
  jmp alltraps
80105ec3:	e9 eb fa ff ff       	jmp    801059b3 <alltraps>

80105ec8 <vector11>:
.globl vector11
vector11:
  pushl $11
80105ec8:	6a 0b                	push   $0xb
  jmp alltraps
80105eca:	e9 e4 fa ff ff       	jmp    801059b3 <alltraps>

80105ecf <vector12>:
.globl vector12
vector12:
  pushl $12
80105ecf:	6a 0c                	push   $0xc
  jmp alltraps
80105ed1:	e9 dd fa ff ff       	jmp    801059b3 <alltraps>

80105ed6 <vector13>:
.globl vector13
vector13:
  pushl $13
80105ed6:	6a 0d                	push   $0xd
  jmp alltraps
80105ed8:	e9 d6 fa ff ff       	jmp    801059b3 <alltraps>

80105edd <vector14>:
.globl vector14
vector14:
  pushl $14
80105edd:	6a 0e                	push   $0xe
  jmp alltraps
80105edf:	e9 cf fa ff ff       	jmp    801059b3 <alltraps>
...
80105ee4:	6a 00                	push   $0x0
  pushl $15
80105ee6:	6a 0f                	push   $0xf
  jmp alltraps
80105ee8:	e9 c6 fa ff ff       	jmp    801059b3 <alltraps>
...
80105eed:	6a 00                	push   $0x0
  pushl $16
80105eef:	6a 10                	push   $0x10
  jmp alltraps
80105ef1:	e9 bd fa ff ff       	jmp    801059b3 <alltraps>

80105ef6 <vector17>:
.globl vector17
vector17:
  pushl $17
80105ef6:	6a 11                	push   $0x11
  jmp alltraps
80105ef8:	e9 b6 fa ff ff       	jmp    801059b3 <alltraps>
...
80105efd:	6a 00                	push   $0x0
  pushl $18
80105eff:	6a 12                	push   $0x12
  jmp alltraps
80105f01:	e9 ad fa ff ff       	jmp    801059b3 <alltraps>
...
80105f06:	6a 00                	push   $0x0
  pushl $19
80105f08:	6a 13                	push   $0x13
  jmp alltraps
80105f0a:	e9 a4 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f0f:	6a 00                	push   $0x0
  pushl $20
80105f11:	6a 14                	push   $0x14
  jmp alltraps
80105f13:	e9 9b fa ff ff       	jmp    801059b3 <alltraps>
...
80105f18:	6a 00                	push   $0x0
  pushl $21
80105f1a:	6a 15                	push   $0x15
  jmp alltraps
80105f1c:	e9 92 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f21:	6a 00                	push   $0x0
  pushl $22
80105f23:	6a 16                	push   $0x16
  jmp alltraps
80105f25:	e9 89 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f2a:	6a 00                	push   $0x0
  pushl $23
80105f2c:	6a 17                	push   $0x17
  jmp alltraps
80105f2e:	e9 80 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f33:	6a 00                	push   $0x0
  pushl $24
80105f35:	6a 18                	push   $0x18
  jmp alltraps
80105f37:	e9 77 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f3c:	6a 00                	push   $0x0
  pushl $25
80105f3e:	6a 19                	push   $0x19
  jmp alltraps
80105f40:	e9 6e fa ff ff       	jmp    801059b3 <alltraps>
...
80105f45:	6a 00                	push   $0x0
  pushl $26
80105f47:	6a 1a                	push   $0x1a
  jmp alltraps
80105f49:	e9 65 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f4e:	6a 00                	push   $0x0
  pushl $27
80105f50:	6a 1b                	push   $0x1b
  jmp alltraps
80105f52:	e9 5c fa ff ff       	jmp    801059b3 <alltraps>
...
80105f57:	6a 00                	push   $0x0
  pushl $28
80105f59:	6a 1c                	push   $0x1c
  jmp alltraps
80105f5b:	e9 53 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f60:	6a 00                	push   $0x0
  pushl $29
80105f62:	6a 1d                	push   $0x1d
  jmp alltraps
80105f64:	e9 4a fa ff ff       	jmp    801059b3 <alltraps>
...
80105f69:	6a 00                	push   $0x0
  pushl $30
80105f6b:	6a 1e                	push   $0x1e
  jmp alltraps
80105f6d:	e9 41 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f72:	6a 00                	push   $0x0
  pushl $31
80105f74:	6a 1f                	push   $0x1f
  jmp alltraps
80105f76:	e9 38 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f7b:	6a 00                	push   $0x0
  pushl $32
80105f7d:	6a 20                	push   $0x20
  jmp alltraps
80105f7f:	e9 2f fa ff ff       	jmp    801059b3 <alltraps>
...
80105f84:	6a 00                	push   $0x0
  pushl $33
80105f86:	6a 21                	push   $0x21
  jmp alltraps
80105f88:	e9 26 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f8d:	6a 00                	push   $0x0
  pushl $34
80105f8f:	6a 22                	push   $0x22
  jmp alltraps
80105f91:	e9 1d fa ff ff       	jmp    801059b3 <alltraps>
...
80105f96:	6a 00                	push   $0x0
  pushl $35
80105f98:	6a 23                	push   $0x23
  jmp alltraps
80105f9a:	e9 14 fa ff ff       	jmp    801059b3 <alltraps>
...
80105f9f:	6a 00                	push   $0x0
  pushl $36
80105fa1:	6a 24                	push   $0x24
  jmp alltraps
80105fa3:	e9 0b fa ff ff       	jmp    801059b3 <alltraps>
...
80105fa8:	6a 00                	push   $0x0
  pushl $37
80105faa:	6a 25                	push   $0x25
  jmp alltraps
80105fac:	e9 02 fa ff ff       	jmp    801059b3 <alltraps>
...
80105fb1:	6a 00                	push   $0x0
  pushl $38
80105fb3:	6a 26                	push   $0x26
  jmp alltraps
80105fb5:	e9 f9 f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fba:	6a 00                	push   $0x0
  pushl $39
80105fbc:	6a 27                	push   $0x27
  jmp alltraps
80105fbe:	e9 f0 f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fc3:	6a 00                	push   $0x0
  pushl $40
80105fc5:	6a 28                	push   $0x28
  jmp alltraps
80105fc7:	e9 e7 f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fcc:	6a 00                	push   $0x0
  pushl $41
80105fce:	6a 29                	push   $0x29
  jmp alltraps
80105fd0:	e9 de f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fd5:	6a 00                	push   $0x0
  pushl $42
80105fd7:	6a 2a                	push   $0x2a
  jmp alltraps
80105fd9:	e9 d5 f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fde:	6a 00                	push   $0x0
  pushl $43
80105fe0:	6a 2b                	push   $0x2b
  jmp alltraps
80105fe2:	e9 cc f9 ff ff       	jmp    801059b3 <alltraps>
...
80105fe7:	6a 00                	push   $0x0
  pushl $44
80105fe9:	6a 2c                	push   $0x2c
  jmp alltraps
80105feb:	e9 c3 f9 ff ff       	jmp    801059b3 <alltraps>
...
80105ff0:	6a 00                	push   $0x0
  pushl $45
80105ff2:	6a 2d                	push   $0x2d
  jmp alltraps
80105ff4:	e9 ba f9 ff ff       	jmp    801059b3 <alltraps>
...
80105ff9:	6a 00                	push   $0x0
  pushl $46
80105ffb:	6a 2e                	push   $0x2e
  jmp alltraps
80105ffd:	e9 b1 f9 ff ff       	jmp    801059b3 <alltraps>
...
80106002:	6a 00                	push   $0x0
  pushl $47
80106004:	6a 2f                	push   $0x2f
  jmp alltraps
80106006:	e9 a8 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010600b:	6a 00                	push   $0x0
  pushl $48
8010600d:	6a 30                	push   $0x30
  jmp alltraps
8010600f:	e9 9f f9 ff ff       	jmp    801059b3 <alltraps>
...
80106014:	6a 00                	push   $0x0
  pushl $49
80106016:	6a 31                	push   $0x31
  jmp alltraps
80106018:	e9 96 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010601d:	6a 00                	push   $0x0
  pushl $50
8010601f:	6a 32                	push   $0x32
  jmp alltraps
80106021:	e9 8d f9 ff ff       	jmp    801059b3 <alltraps>
...
80106026:	6a 00                	push   $0x0
  pushl $51
80106028:	6a 33                	push   $0x33
  jmp alltraps
8010602a:	e9 84 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010602f:	6a 00                	push   $0x0
  pushl $52
80106031:	6a 34                	push   $0x34
  jmp alltraps
80106033:	e9 7b f9 ff ff       	jmp    801059b3 <alltraps>
...
80106038:	6a 00                	push   $0x0
  pushl $53
8010603a:	6a 35                	push   $0x35
  jmp alltraps
8010603c:	e9 72 f9 ff ff       	jmp    801059b3 <alltraps>
...
80106041:	6a 00                	push   $0x0
  pushl $54
80106043:	6a 36                	push   $0x36
  jmp alltraps
80106045:	e9 69 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010604a:	6a 00                	push   $0x0
  pushl $55
8010604c:	6a 37                	push   $0x37
  jmp alltraps
8010604e:	e9 60 f9 ff ff       	jmp    801059b3 <alltraps>
...
80106053:	6a 00                	push   $0x0
  pushl $56
80106055:	6a 38                	push   $0x38
  jmp alltraps
80106057:	e9 57 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010605c:	6a 00                	push   $0x0
  pushl $57
8010605e:	6a 39                	push   $0x39
  jmp alltraps
80106060:	e9 4e f9 ff ff       	jmp    801059b3 <alltraps>
...
80106065:	6a 00                	push   $0x0
  pushl $58
80106067:	6a 3a                	push   $0x3a
  jmp alltraps
80106069:	e9 45 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010606e:	6a 00                	push   $0x0
  pushl $59
80106070:	6a 3b                	push   $0x3b
  jmp alltraps
80106072:	e9 3c f9 ff ff       	jmp    801059b3 <alltraps>
...
80106077:	6a 00                	push   $0x0
  pushl $60
80106079:	6a 3c                	push   $0x3c
  jmp alltraps
8010607b:	e9 33 f9 ff ff       	jmp    801059b3 <alltraps>
...
80106080:	6a 00                	push   $0x0
  pushl $61
80106082:	6a 3d                	push   $0x3d
  jmp alltraps
80106084:	e9 2a f9 ff ff       	jmp    801059b3 <alltraps>
...
80106089:	6a 00                	push   $0x0
  pushl $62
8010608b:	6a 3e                	push   $0x3e
  jmp alltraps
8010608d:	e9 21 f9 ff ff       	jmp    801059b3 <alltraps>
...
80106092:	6a 00                	push   $0x0
  pushl $63
80106094:	6a 3f                	push   $0x3f
  jmp alltraps
80106096:	e9 18 f9 ff ff       	jmp    801059b3 <alltraps>
...
8010609b:	6a 00                	push   $0x0
  pushl $64
8010609d:	6a 40                	push   $0x40
  jmp alltraps
8010609f:	e9 0f f9 ff ff       	jmp    801059b3 <alltraps>
...
801060a4:	6a 00                	push   $0x0
  pushl $65
801060a6:	6a 41                	push   $0x41
  jmp alltraps
801060a8:	e9 06 f9 ff ff       	jmp    801059b3 <alltraps>
...
801060ad:	6a 00                	push   $0x0
  pushl $66
801060af:	6a 42                	push   $0x42
  jmp alltraps
801060b1:	e9 fd f8 ff ff       	jmp    801059b3 <alltraps>
...
801060b6:	6a 00                	push   $0x0
  pushl $67
801060b8:	6a 43                	push   $0x43
  jmp alltraps
801060ba:	e9 f4 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060bf:	6a 00                	push   $0x0
  pushl $68
801060c1:	6a 44                	push   $0x44
  jmp alltraps
801060c3:	e9 eb f8 ff ff       	jmp    801059b3 <alltraps>
...
801060c8:	6a 00                	push   $0x0
  pushl $69
801060ca:	6a 45                	push   $0x45
  jmp alltraps
801060cc:	e9 e2 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060d1:	6a 00                	push   $0x0
  pushl $70
801060d3:	6a 46                	push   $0x46
  jmp alltraps
801060d5:	e9 d9 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060da:	6a 00                	push   $0x0
  pushl $71
801060dc:	6a 47                	push   $0x47
  jmp alltraps
801060de:	e9 d0 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060e3:	6a 00                	push   $0x0
  pushl $72
801060e5:	6a 48                	push   $0x48
  jmp alltraps
801060e7:	e9 c7 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060ec:	6a 00                	push   $0x0
  pushl $73
801060ee:	6a 49                	push   $0x49
  jmp alltraps
801060f0:	e9 be f8 ff ff       	jmp    801059b3 <alltraps>
...
801060f5:	6a 00                	push   $0x0
  pushl $74
801060f7:	6a 4a                	push   $0x4a
  jmp alltraps
801060f9:	e9 b5 f8 ff ff       	jmp    801059b3 <alltraps>
...
801060fe:	6a 00                	push   $0x0
  pushl $75
80106100:	6a 4b                	push   $0x4b
  jmp alltraps
80106102:	e9 ac f8 ff ff       	jmp    801059b3 <alltraps>
...
80106107:	6a 00                	push   $0x0
  pushl $76
80106109:	6a 4c                	push   $0x4c
  jmp alltraps
8010610b:	e9 a3 f8 ff ff       	jmp    801059b3 <alltraps>
...
80106110:	6a 00                	push   $0x0
  pushl $77
80106112:	6a 4d                	push   $0x4d
  jmp alltraps
80106114:	e9 9a f8 ff ff       	jmp    801059b3 <alltraps>
...
80106119:	6a 00                	push   $0x0
  pushl $78
8010611b:	6a 4e                	push   $0x4e
  jmp alltraps
8010611d:	e9 91 f8 ff ff       	jmp    801059b3 <alltraps>
...
80106122:	6a 00                	push   $0x0
  pushl $79
80106124:	6a 4f                	push   $0x4f
  jmp alltraps
80106126:	e9 88 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010612b:	6a 00                	push   $0x0
  pushl $80
8010612d:	6a 50                	push   $0x50
  jmp alltraps
8010612f:	e9 7f f8 ff ff       	jmp    801059b3 <alltraps>
...
80106134:	6a 00                	push   $0x0
  pushl $81
80106136:	6a 51                	push   $0x51
  jmp alltraps
80106138:	e9 76 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010613d:	6a 00                	push   $0x0
  pushl $82
8010613f:	6a 52                	push   $0x52
  jmp alltraps
80106141:	e9 6d f8 ff ff       	jmp    801059b3 <alltraps>
...
80106146:	6a 00                	push   $0x0
  pushl $83
80106148:	6a 53                	push   $0x53
  jmp alltraps
8010614a:	e9 64 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010614f:	6a 00                	push   $0x0
  pushl $84
80106151:	6a 54                	push   $0x54
  jmp alltraps
80106153:	e9 5b f8 ff ff       	jmp    801059b3 <alltraps>
...
80106158:	6a 00                	push   $0x0
  pushl $85
8010615a:	6a 55                	push   $0x55
  jmp alltraps
8010615c:	e9 52 f8 ff ff       	jmp    801059b3 <alltraps>
...
80106161:	6a 00                	push   $0x0
  pushl $86
80106163:	6a 56                	push   $0x56
  jmp alltraps
80106165:	e9 49 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010616a:	6a 00                	push   $0x0
  pushl $87
8010616c:	6a 57                	push   $0x57
  jmp alltraps
8010616e:	e9 40 f8 ff ff       	jmp    801059b3 <alltraps>
...
80106173:	6a 00                	push   $0x0
  pushl $88
80106175:	6a 58                	push   $0x58
  jmp alltraps
80106177:	e9 37 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010617c:	6a 00                	push   $0x0
  pushl $89
8010617e:	6a 59                	push   $0x59
  jmp alltraps
80106180:	e9 2e f8 ff ff       	jmp    801059b3 <alltraps>
...
80106185:	6a 00                	push   $0x0
  pushl $90
80106187:	6a 5a                	push   $0x5a
  jmp alltraps
80106189:	e9 25 f8 ff ff       	jmp    801059b3 <alltraps>
...
8010618e:	6a 00                	push   $0x0
  pushl $91
80106190:	6a 5b                	push   $0x5b
  jmp alltraps
80106192:	e9 1c f8 ff ff       	jmp    801059b3 <alltraps>
...
80106197:	6a 00                	push   $0x0
  pushl $92
80106199:	6a 5c                	push   $0x5c
  jmp alltraps
8010619b:	e9 13 f8 ff ff       	jmp    801059b3 <alltraps>
...
801061a0:	6a 00                	push   $0x0
  pushl $93
801061a2:	6a 5d                	push   $0x5d
  jmp alltraps
801061a4:	e9 0a f8 ff ff       	jmp    801059b3 <alltraps>
...
801061a9:	6a 00                	push   $0x0
  pushl $94
801061ab:	6a 5e                	push   $0x5e
  jmp alltraps
801061ad:	e9 01 f8 ff ff       	jmp    801059b3 <alltraps>
...
801061b2:	6a 00                	push   $0x0
  pushl $95
801061b4:	6a 5f                	push   $0x5f
  jmp alltraps
801061b6:	e9 f8 f7 ff ff       	jmp    801059b3 <alltraps>
...
801061bb:	6a 00                	push   $0x0
  pushl $96
801061bd:	6a 60                	push   $0x60
  jmp alltraps
801061bf:	e9 ef f7 ff ff       	jmp    801059b3 <alltraps>
...
801061c4:	6a 00                	push   $0x0
  pushl $97
801061c6:	6a 61                	push   $0x61
  jmp alltraps
801061c8:	e9 e6 f7 ff ff       	jmp    801059b3 <alltraps>
...
801061cd:	6a 00                	push   $0x0
  pushl $98
801061cf:	6a 62                	push   $0x62
  jmp alltraps
801061d1:	e9 dd f7 ff ff       	jmp    801059b3 <alltraps>
...
801061d6:	6a 00                	push   $0x0
  pushl $99
801061d8:	6a 63                	push   $0x63
  jmp alltraps
801061da:	e9 d4 f7 ff ff       	jmp    801059b3 <alltraps>
...
801061df:	6a 00                	push   $0x0
  pushl $100
801061e1:	6a 64                	push   $0x64
  jmp alltraps
801061e3:	e9 cb f7 ff ff       	jmp    801059b3 <alltraps>
...
801061e8:	6a 00                	push   $0x0
  pushl $101
801061ea:	6a 65                	push   $0x65
  jmp alltraps
801061ec:	e9 c2 f7 ff ff       	jmp    801059b3 <alltraps>
...
801061f1:	6a 00                	push   $0x0
  pushl $102
801061f3:	6a 66                	push   $0x66
  jmp alltraps
801061f5:	e9 b9 f7 ff ff       	jmp    801059b3 <alltraps>
...
801061fa:	6a 00                	push   $0x0
  pushl $103
801061fc:	6a 67                	push   $0x67
  jmp alltraps
801061fe:	e9 b0 f7 ff ff       	jmp    801059b3 <alltraps>
...
80106203:	6a 00                	push   $0x0
  pushl $104
80106205:	6a 68                	push   $0x68
  jmp alltraps
80106207:	e9 a7 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010620c:	6a 00                	push   $0x0
  pushl $105
8010620e:	6a 69                	push   $0x69
  jmp alltraps
80106210:	e9 9e f7 ff ff       	jmp    801059b3 <alltraps>
...
80106215:	6a 00                	push   $0x0
  pushl $106
80106217:	6a 6a                	push   $0x6a
  jmp alltraps
80106219:	e9 95 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010621e:	6a 00                	push   $0x0
  pushl $107
80106220:	6a 6b                	push   $0x6b
  jmp alltraps
80106222:	e9 8c f7 ff ff       	jmp    801059b3 <alltraps>
...
80106227:	6a 00                	push   $0x0
  pushl $108
80106229:	6a 6c                	push   $0x6c
  jmp alltraps
8010622b:	e9 83 f7 ff ff       	jmp    801059b3 <alltraps>
...
80106230:	6a 00                	push   $0x0
  pushl $109
80106232:	6a 6d                	push   $0x6d
  jmp alltraps
80106234:	e9 7a f7 ff ff       	jmp    801059b3 <alltraps>
...
80106239:	6a 00                	push   $0x0
  pushl $110
8010623b:	6a 6e                	push   $0x6e
  jmp alltraps
8010623d:	e9 71 f7 ff ff       	jmp    801059b3 <alltraps>
...
80106242:	6a 00                	push   $0x0
  pushl $111
80106244:	6a 6f                	push   $0x6f
  jmp alltraps
80106246:	e9 68 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010624b:	6a 00                	push   $0x0
  pushl $112
8010624d:	6a 70                	push   $0x70
  jmp alltraps
8010624f:	e9 5f f7 ff ff       	jmp    801059b3 <alltraps>
...
80106254:	6a 00                	push   $0x0
  pushl $113
80106256:	6a 71                	push   $0x71
  jmp alltraps
80106258:	e9 56 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010625d:	6a 00                	push   $0x0
  pushl $114
8010625f:	6a 72                	push   $0x72
  jmp alltraps
80106261:	e9 4d f7 ff ff       	jmp    801059b3 <alltraps>
...
80106266:	6a 00                	push   $0x0
  pushl $115
80106268:	6a 73                	push   $0x73
  jmp alltraps
8010626a:	e9 44 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010626f:	6a 00                	push   $0x0
  pushl $116
80106271:	6a 74                	push   $0x74
  jmp alltraps
80106273:	e9 3b f7 ff ff       	jmp    801059b3 <alltraps>
...
80106278:	6a 00                	push   $0x0
  pushl $117
8010627a:	6a 75                	push   $0x75
  jmp alltraps
8010627c:	e9 32 f7 ff ff       	jmp    801059b3 <alltraps>
...
80106281:	6a 00                	push   $0x0
  pushl $118
80106283:	6a 76                	push   $0x76
  jmp alltraps
80106285:	e9 29 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010628a:	6a 00                	push   $0x0
  pushl $119
8010628c:	6a 77                	push   $0x77
  jmp alltraps
8010628e:	e9 20 f7 ff ff       	jmp    801059b3 <alltraps>
...
80106293:	6a 00                	push   $0x0
  pushl $120
80106295:	6a 78                	push   $0x78
  jmp alltraps
80106297:	e9 17 f7 ff ff       	jmp    801059b3 <alltraps>
...
8010629c:	6a 00                	push   $0x0
  pushl $121
8010629e:	6a 79                	push   $0x79
  jmp alltraps
801062a0:	e9 0e f7 ff ff       	jmp    801059b3 <alltraps>
...
801062a5:	6a 00                	push   $0x0
  pushl $122
801062a7:	6a 7a                	push   $0x7a
  jmp alltraps
801062a9:	e9 05 f7 ff ff       	jmp    801059b3 <alltraps>
...
801062ae:	6a 00                	push   $0x0
  pushl $123
801062b0:	6a 7b                	push   $0x7b
  jmp alltraps
801062b2:	e9 fc f6 ff ff       	jmp    801059b3 <alltraps>
...
801062b7:	6a 00                	push   $0x0
  pushl $124
801062b9:	6a 7c                	push   $0x7c
  jmp alltraps
801062bb:	e9 f3 f6 ff ff       	jmp    801059b3 <alltraps>
...
801062c0:	6a 00                	push   $0x0
  pushl $125
801062c2:	6a 7d                	push   $0x7d
  jmp alltraps
801062c4:	e9 ea f6 ff ff       	jmp    801059b3 <alltraps>
...
801062c9:	6a 00                	push   $0x0
  pushl $126
801062cb:	6a 7e                	push   $0x7e
  jmp alltraps
801062cd:	e9 e1 f6 ff ff       	jmp    801059b3 <alltraps>
...
801062d2:	6a 00                	push   $0x0
  pushl $127
801062d4:	6a 7f                	push   $0x7f
  jmp alltraps
801062d6:	e9 d8 f6 ff ff       	jmp    801059b3 <alltraps>
...
801062db:	6a 00                	push   $0x0
  pushl $128
801062dd:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062e2:	e9 cc f6 ff ff       	jmp    801059b3 <alltraps>
...
801062e7:	6a 00                	push   $0x0
  pushl $129
801062e9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062ee:	e9 c0 f6 ff ff       	jmp    801059b3 <alltraps>
...
801062f3:	6a 00                	push   $0x0
  pushl $130
801062f5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801062fa:	e9 b4 f6 ff ff       	jmp    801059b3 <alltraps>
...
801062ff:	6a 00                	push   $0x0
  pushl $131
80106301:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106306:	e9 a8 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010630b:	6a 00                	push   $0x0
  pushl $132
8010630d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106312:	e9 9c f6 ff ff       	jmp    801059b3 <alltraps>
...
80106317:	6a 00                	push   $0x0
  pushl $133
80106319:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010631e:	e9 90 f6 ff ff       	jmp    801059b3 <alltraps>
...
80106323:	6a 00                	push   $0x0
  pushl $134
80106325:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010632a:	e9 84 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010632f:	6a 00                	push   $0x0
  pushl $135
80106331:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106336:	e9 78 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010633b:	6a 00                	push   $0x0
  pushl $136
8010633d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106342:	e9 6c f6 ff ff       	jmp    801059b3 <alltraps>
...
80106347:	6a 00                	push   $0x0
  pushl $137
80106349:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010634e:	e9 60 f6 ff ff       	jmp    801059b3 <alltraps>
...
80106353:	6a 00                	push   $0x0
  pushl $138
80106355:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010635a:	e9 54 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010635f:	6a 00                	push   $0x0
  pushl $139
80106361:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106366:	e9 48 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010636b:	6a 00                	push   $0x0
  pushl $140
8010636d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106372:	e9 3c f6 ff ff       	jmp    801059b3 <alltraps>
...
80106377:	6a 00                	push   $0x0
  pushl $141
80106379:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010637e:	e9 30 f6 ff ff       	jmp    801059b3 <alltraps>
...
80106383:	6a 00                	push   $0x0
  pushl $142
80106385:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010638a:	e9 24 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010638f:	6a 00                	push   $0x0
  pushl $143
80106391:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106396:	e9 18 f6 ff ff       	jmp    801059b3 <alltraps>
...
8010639b:	6a 00                	push   $0x0
  pushl $144
8010639d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063a2:	e9 0c f6 ff ff       	jmp    801059b3 <alltraps>
...
801063a7:	6a 00                	push   $0x0
  pushl $145
801063a9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063ae:	e9 00 f6 ff ff       	jmp    801059b3 <alltraps>
...
801063b3:	6a 00                	push   $0x0
  pushl $146
801063b5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063ba:	e9 f4 f5 ff ff       	jmp    801059b3 <alltraps>
...
801063bf:	6a 00                	push   $0x0
  pushl $147
801063c1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063c6:	e9 e8 f5 ff ff       	jmp    801059b3 <alltraps>
...
801063cb:	6a 00                	push   $0x0
  pushl $148
801063cd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063d2:	e9 dc f5 ff ff       	jmp    801059b3 <alltraps>
...
801063d7:	6a 00                	push   $0x0
  pushl $149
801063d9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063de:	e9 d0 f5 ff ff       	jmp    801059b3 <alltraps>
...
801063e3:	6a 00                	push   $0x0
  pushl $150
801063e5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063ea:	e9 c4 f5 ff ff       	jmp    801059b3 <alltraps>
...
801063ef:	6a 00                	push   $0x0
  pushl $151
801063f1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801063f6:	e9 b8 f5 ff ff       	jmp    801059b3 <alltraps>
...
801063fb:	6a 00                	push   $0x0
  pushl $152
801063fd:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106402:	e9 ac f5 ff ff       	jmp    801059b3 <alltraps>
...
80106407:	6a 00                	push   $0x0
  pushl $153
80106409:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010640e:	e9 a0 f5 ff ff       	jmp    801059b3 <alltraps>
...
80106413:	6a 00                	push   $0x0
  pushl $154
80106415:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010641a:	e9 94 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010641f:	6a 00                	push   $0x0
  pushl $155
80106421:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106426:	e9 88 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010642b:	6a 00                	push   $0x0
  pushl $156
8010642d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106432:	e9 7c f5 ff ff       	jmp    801059b3 <alltraps>
...
80106437:	6a 00                	push   $0x0
  pushl $157
80106439:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010643e:	e9 70 f5 ff ff       	jmp    801059b3 <alltraps>
...
80106443:	6a 00                	push   $0x0
  pushl $158
80106445:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010644a:	e9 64 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010644f:	6a 00                	push   $0x0
  pushl $159
80106451:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106456:	e9 58 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010645b:	6a 00                	push   $0x0
  pushl $160
8010645d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106462:	e9 4c f5 ff ff       	jmp    801059b3 <alltraps>
...
80106467:	6a 00                	push   $0x0
  pushl $161
80106469:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010646e:	e9 40 f5 ff ff       	jmp    801059b3 <alltraps>
...
80106473:	6a 00                	push   $0x0
  pushl $162
80106475:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010647a:	e9 34 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010647f:	6a 00                	push   $0x0
  pushl $163
80106481:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106486:	e9 28 f5 ff ff       	jmp    801059b3 <alltraps>
...
8010648b:	6a 00                	push   $0x0
  pushl $164
8010648d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106492:	e9 1c f5 ff ff       	jmp    801059b3 <alltraps>
...
80106497:	6a 00                	push   $0x0
  pushl $165
80106499:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010649e:	e9 10 f5 ff ff       	jmp    801059b3 <alltraps>
...
801064a3:	6a 00                	push   $0x0
  pushl $166
801064a5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064aa:	e9 04 f5 ff ff       	jmp    801059b3 <alltraps>
...
801064af:	6a 00                	push   $0x0
  pushl $167
801064b1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064b6:	e9 f8 f4 ff ff       	jmp    801059b3 <alltraps>
...
801064bb:	6a 00                	push   $0x0
  pushl $168
801064bd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064c2:	e9 ec f4 ff ff       	jmp    801059b3 <alltraps>
...
801064c7:	6a 00                	push   $0x0
  pushl $169
801064c9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064ce:	e9 e0 f4 ff ff       	jmp    801059b3 <alltraps>
...
801064d3:	6a 00                	push   $0x0
  pushl $170
801064d5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064da:	e9 d4 f4 ff ff       	jmp    801059b3 <alltraps>
...
801064df:	6a 00                	push   $0x0
  pushl $171
801064e1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064e6:	e9 c8 f4 ff ff       	jmp    801059b3 <alltraps>
...
801064eb:	6a 00                	push   $0x0
  pushl $172
801064ed:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064f2:	e9 bc f4 ff ff       	jmp    801059b3 <alltraps>
...
801064f7:	6a 00                	push   $0x0
  pushl $173
801064f9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801064fe:	e9 b0 f4 ff ff       	jmp    801059b3 <alltraps>
...
80106503:	6a 00                	push   $0x0
  pushl $174
80106505:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010650a:	e9 a4 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010650f:	6a 00                	push   $0x0
  pushl $175
80106511:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106516:	e9 98 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010651b:	6a 00                	push   $0x0
  pushl $176
8010651d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106522:	e9 8c f4 ff ff       	jmp    801059b3 <alltraps>
...
80106527:	6a 00                	push   $0x0
  pushl $177
80106529:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010652e:	e9 80 f4 ff ff       	jmp    801059b3 <alltraps>
...
80106533:	6a 00                	push   $0x0
  pushl $178
80106535:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010653a:	e9 74 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010653f:	6a 00                	push   $0x0
  pushl $179
80106541:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106546:	e9 68 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010654b:	6a 00                	push   $0x0
  pushl $180
8010654d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106552:	e9 5c f4 ff ff       	jmp    801059b3 <alltraps>
...
80106557:	6a 00                	push   $0x0
  pushl $181
80106559:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010655e:	e9 50 f4 ff ff       	jmp    801059b3 <alltraps>
...
80106563:	6a 00                	push   $0x0
  pushl $182
80106565:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010656a:	e9 44 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010656f:	6a 00                	push   $0x0
  pushl $183
80106571:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106576:	e9 38 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010657b:	6a 00                	push   $0x0
  pushl $184
8010657d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106582:	e9 2c f4 ff ff       	jmp    801059b3 <alltraps>
...
80106587:	6a 00                	push   $0x0
  pushl $185
80106589:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010658e:	e9 20 f4 ff ff       	jmp    801059b3 <alltraps>
...
80106593:	6a 00                	push   $0x0
  pushl $186
80106595:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010659a:	e9 14 f4 ff ff       	jmp    801059b3 <alltraps>
...
8010659f:	6a 00                	push   $0x0
  pushl $187
801065a1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065a6:	e9 08 f4 ff ff       	jmp    801059b3 <alltraps>
...
801065ab:	6a 00                	push   $0x0
  pushl $188
801065ad:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065b2:	e9 fc f3 ff ff       	jmp    801059b3 <alltraps>
...
801065b7:	6a 00                	push   $0x0
  pushl $189
801065b9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065be:	e9 f0 f3 ff ff       	jmp    801059b3 <alltraps>
...
801065c3:	6a 00                	push   $0x0
  pushl $190
801065c5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065ca:	e9 e4 f3 ff ff       	jmp    801059b3 <alltraps>
...
801065cf:	6a 00                	push   $0x0
  pushl $191
801065d1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065d6:	e9 d8 f3 ff ff       	jmp    801059b3 <alltraps>
...
801065db:	6a 00                	push   $0x0
  pushl $192
801065dd:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065e2:	e9 cc f3 ff ff       	jmp    801059b3 <alltraps>
...
801065e7:	6a 00                	push   $0x0
  pushl $193
801065e9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065ee:	e9 c0 f3 ff ff       	jmp    801059b3 <alltraps>
...
801065f3:	6a 00                	push   $0x0
  pushl $194
801065f5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801065fa:	e9 b4 f3 ff ff       	jmp    801059b3 <alltraps>
...
801065ff:	6a 00                	push   $0x0
  pushl $195
80106601:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106606:	e9 a8 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010660b:	6a 00                	push   $0x0
  pushl $196
8010660d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106612:	e9 9c f3 ff ff       	jmp    801059b3 <alltraps>
...
80106617:	6a 00                	push   $0x0
  pushl $197
80106619:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010661e:	e9 90 f3 ff ff       	jmp    801059b3 <alltraps>
...
80106623:	6a 00                	push   $0x0
  pushl $198
80106625:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010662a:	e9 84 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010662f:	6a 00                	push   $0x0
  pushl $199
80106631:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106636:	e9 78 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010663b:	6a 00                	push   $0x0
  pushl $200
8010663d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106642:	e9 6c f3 ff ff       	jmp    801059b3 <alltraps>
...
80106647:	6a 00                	push   $0x0
  pushl $201
80106649:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010664e:	e9 60 f3 ff ff       	jmp    801059b3 <alltraps>
...
80106653:	6a 00                	push   $0x0
  pushl $202
80106655:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010665a:	e9 54 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010665f:	6a 00                	push   $0x0
  pushl $203
80106661:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106666:	e9 48 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010666b:	6a 00                	push   $0x0
  pushl $204
8010666d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106672:	e9 3c f3 ff ff       	jmp    801059b3 <alltraps>
...
80106677:	6a 00                	push   $0x0
  pushl $205
80106679:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010667e:	e9 30 f3 ff ff       	jmp    801059b3 <alltraps>
...
80106683:	6a 00                	push   $0x0
  pushl $206
80106685:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010668a:	e9 24 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010668f:	6a 00                	push   $0x0
  pushl $207
80106691:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106696:	e9 18 f3 ff ff       	jmp    801059b3 <alltraps>
...
8010669b:	6a 00                	push   $0x0
  pushl $208
8010669d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066a2:	e9 0c f3 ff ff       	jmp    801059b3 <alltraps>
...
801066a7:	6a 00                	push   $0x0
  pushl $209
801066a9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066ae:	e9 00 f3 ff ff       	jmp    801059b3 <alltraps>
...
801066b3:	6a 00                	push   $0x0
  pushl $210
801066b5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066ba:	e9 f4 f2 ff ff       	jmp    801059b3 <alltraps>
...
801066bf:	6a 00                	push   $0x0
  pushl $211
801066c1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066c6:	e9 e8 f2 ff ff       	jmp    801059b3 <alltraps>
...
801066cb:	6a 00                	push   $0x0
  pushl $212
801066cd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066d2:	e9 dc f2 ff ff       	jmp    801059b3 <alltraps>
...
801066d7:	6a 00                	push   $0x0
  pushl $213
801066d9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066de:	e9 d0 f2 ff ff       	jmp    801059b3 <alltraps>
...
801066e3:	6a 00                	push   $0x0
  pushl $214
801066e5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066ea:	e9 c4 f2 ff ff       	jmp    801059b3 <alltraps>
...
801066ef:	6a 00                	push   $0x0
  pushl $215
801066f1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801066f6:	e9 b8 f2 ff ff       	jmp    801059b3 <alltraps>
...
801066fb:	6a 00                	push   $0x0
  pushl $216
801066fd:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106702:	e9 ac f2 ff ff       	jmp    801059b3 <alltraps>
...
80106707:	6a 00                	push   $0x0
  pushl $217
80106709:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010670e:	e9 a0 f2 ff ff       	jmp    801059b3 <alltraps>
...
80106713:	6a 00                	push   $0x0
  pushl $218
80106715:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010671a:	e9 94 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010671f:	6a 00                	push   $0x0
  pushl $219
80106721:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106726:	e9 88 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010672b:	6a 00                	push   $0x0
  pushl $220
8010672d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106732:	e9 7c f2 ff ff       	jmp    801059b3 <alltraps>
...
80106737:	6a 00                	push   $0x0
  pushl $221
80106739:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010673e:	e9 70 f2 ff ff       	jmp    801059b3 <alltraps>
...
80106743:	6a 00                	push   $0x0
  pushl $222
80106745:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010674a:	e9 64 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010674f:	6a 00                	push   $0x0
  pushl $223
80106751:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106756:	e9 58 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010675b:	6a 00                	push   $0x0
  pushl $224
8010675d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106762:	e9 4c f2 ff ff       	jmp    801059b3 <alltraps>
...
80106767:	6a 00                	push   $0x0
  pushl $225
80106769:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010676e:	e9 40 f2 ff ff       	jmp    801059b3 <alltraps>
...
80106773:	6a 00                	push   $0x0
  pushl $226
80106775:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010677a:	e9 34 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010677f:	6a 00                	push   $0x0
  pushl $227
80106781:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106786:	e9 28 f2 ff ff       	jmp    801059b3 <alltraps>
...
8010678b:	6a 00                	push   $0x0
  pushl $228
8010678d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106792:	e9 1c f2 ff ff       	jmp    801059b3 <alltraps>
...
80106797:	6a 00                	push   $0x0
  pushl $229
80106799:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010679e:	e9 10 f2 ff ff       	jmp    801059b3 <alltraps>
...
801067a3:	6a 00                	push   $0x0
  pushl $230
801067a5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067aa:	e9 04 f2 ff ff       	jmp    801059b3 <alltraps>
...
801067af:	6a 00                	push   $0x0
  pushl $231
801067b1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067b6:	e9 f8 f1 ff ff       	jmp    801059b3 <alltraps>
...
801067bb:	6a 00                	push   $0x0
  pushl $232
801067bd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067c2:	e9 ec f1 ff ff       	jmp    801059b3 <alltraps>
...
801067c7:	6a 00                	push   $0x0
  pushl $233
801067c9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067ce:	e9 e0 f1 ff ff       	jmp    801059b3 <alltraps>
...
801067d3:	6a 00                	push   $0x0
  pushl $234
801067d5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067da:	e9 d4 f1 ff ff       	jmp    801059b3 <alltraps>
...
801067df:	6a 00                	push   $0x0
  pushl $235
801067e1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067e6:	e9 c8 f1 ff ff       	jmp    801059b3 <alltraps>
...
801067eb:	6a 00                	push   $0x0
  pushl $236
801067ed:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067f2:	e9 bc f1 ff ff       	jmp    801059b3 <alltraps>
...
801067f7:	6a 00                	push   $0x0
  pushl $237
801067f9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801067fe:	e9 b0 f1 ff ff       	jmp    801059b3 <alltraps>
...
80106803:	6a 00                	push   $0x0
  pushl $238
80106805:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010680a:	e9 a4 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010680f:	6a 00                	push   $0x0
  pushl $239
80106811:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106816:	e9 98 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010681b:	6a 00                	push   $0x0
  pushl $240
8010681d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106822:	e9 8c f1 ff ff       	jmp    801059b3 <alltraps>
...
80106827:	6a 00                	push   $0x0
  pushl $241
80106829:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010682e:	e9 80 f1 ff ff       	jmp    801059b3 <alltraps>
...
80106833:	6a 00                	push   $0x0
  pushl $242
80106835:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010683a:	e9 74 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010683f:	6a 00                	push   $0x0
  pushl $243
80106841:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106846:	e9 68 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010684b:	6a 00                	push   $0x0
  pushl $244
8010684d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106852:	e9 5c f1 ff ff       	jmp    801059b3 <alltraps>
...
80106857:	6a 00                	push   $0x0
  pushl $245
80106859:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010685e:	e9 50 f1 ff ff       	jmp    801059b3 <alltraps>
...
80106863:	6a 00                	push   $0x0
  pushl $246
80106865:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010686a:	e9 44 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010686f:	6a 00                	push   $0x0
  pushl $247
80106871:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106876:	e9 38 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010687b:	6a 00                	push   $0x0
  pushl $248
8010687d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106882:	e9 2c f1 ff ff       	jmp    801059b3 <alltraps>
...
80106887:	6a 00                	push   $0x0
  pushl $249
80106889:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010688e:	e9 20 f1 ff ff       	jmp    801059b3 <alltraps>
...
80106893:	6a 00                	push   $0x0
  pushl $250
80106895:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010689a:	e9 14 f1 ff ff       	jmp    801059b3 <alltraps>
...
8010689f:	6a 00                	push   $0x0
  pushl $251
801068a1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068a6:	e9 08 f1 ff ff       	jmp    801059b3 <alltraps>
...
801068ab:	6a 00                	push   $0x0
  pushl $252
801068ad:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068b2:	e9 fc f0 ff ff       	jmp    801059b3 <alltraps>
...
801068b7:	6a 00                	push   $0x0
  pushl $253
801068b9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068be:	e9 f0 f0 ff ff       	jmp    801059b3 <alltraps>
...
801068c3:	6a 00                	push   $0x0
  pushl $254
801068c5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068ca:	e9 e4 f0 ff ff       	jmp    801059b3 <alltraps>
...
801068cf:	6a 00                	push   $0x0
  pushl $255
801068d1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068d6:	e9 d8 f0 ff ff       	jmp    801059b3 <alltraps>
...
801068ee:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
801068f1:	8b 1f                	mov    (%edi),%ebx
801068f3:	f6 c3 01             	test   $0x1,%bl
801068f6:	74 28                	je     80106920 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801068f8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801068fe:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106904:	89 f0                	mov    %esi,%eax
}
80106906:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106909:	c1 e8 0a             	shr    $0xa,%eax
8010690c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106911:	01 d8                	add    %ebx,%eax
}
80106913:	5b                   	pop    %ebx
80106914:	5e                   	pop    %esi
80106915:	5f                   	pop    %edi
...
80106924:	e8 07 bd ff ff       	call   80102630 <kalloc>
...
80106966:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
8010696a:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010696b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106970:	89 d6                	mov    %edx,%esi
{
80106972:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106973:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106979:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
8010697c:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010697f:	8b 45 08             	mov    0x8(%ebp),%eax
80106982:	29 f0                	sub    %esi,%eax
80106984:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106987:	eb 1f                	jmp    801069a8 <mappages+0x48>
...
801069b2:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
801069b5:	89 f8                	mov    %edi,%eax
801069b7:	e8 24 ff ff ff       	call   801068e0 <walkpgdir>
801069bc:	85 c0                	test   %eax,%eax
801069be:	75 d0                	jne    80106990 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
801069dd:	68 cc 7a 10 80       	push   $0x80107acc
...
801069f5:	89 c6                	mov    %eax,%esi
801069f7:	53                   	push   %ebx
801069f8:	89 d3                	mov    %edx,%ebx
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
801069fa:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106a00:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106a06:	83 ec 1c             	sub    $0x1c,%esp
80106a09:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a0c:	39 da                	cmp    %ebx,%edx
80106a0e:	73 5b                	jae    80106a6b <deallocuvm.part.0+0x7b>
80106a10:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106a13:	89 d7                	mov    %edx,%edi
80106a15:	eb 14                	jmp    80106a2b <deallocuvm.part.0+0x3b>
80106a17:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106a1e:	66 90                	xchg   %ax,%ax
80106a20:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106a26:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106a29:	76 40                	jbe    80106a6b <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106a2b:	31 c9                	xor    %ecx,%ecx
80106a2d:	89 fa                	mov    %edi,%edx
80106a2f:	89 f0                	mov    %esi,%eax
80106a31:	e8 aa fe ff ff       	call   801068e0 <walkpgdir>
80106a36:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106a38:	85 c0                	test   %eax,%eax
80106a3a:	74 44                	je     80106a80 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106a3c:	8b 00                	mov    (%eax),%eax
80106a3e:	a8 01                	test   $0x1,%al
80106a40:	74 de                	je     80106a20 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106a42:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106a47:	74 47                	je     80106a90 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106a49:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106a4c:	05 00 00 00 80       	add    $0x80000000,%eax
80106a51:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106a57:	50                   	push   %eax
80106a58:	e8 13 ba ff ff       	call   80102470 <kfree>
      *pte = 0;
80106a5d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106a63:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106a66:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106a69:	77 c0                	ja     80106a2b <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
80106a6b:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106a82:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106a88:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106a8e:	eb 96                	jmp    80106a26 <deallocuvm.part.0+0x36>
        panic("kfree");
80106a90:	83 ec 0c             	sub    $0xc,%esp
80106a93:	68 86 74 10 80       	push   $0x80107486
80106a98:	e8 f3 98 ff ff       	call   80100390 <panic>
...
80106aa7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106aaa:	e8 91 ce ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106b34:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106b62:	0f 84 cb 00 00 00    	je     80106c33 <switchuvm+0xe3>
  if(p->kstack == 0)
80106b68:	8b 46 08             	mov    0x8(%esi),%eax
80106b6b:	85 c0                	test   %eax,%eax
80106b6d:	0f 84 da 00 00 00    	je     80106c4d <switchuvm+0xfd>
  if(p->pgdir == 0)
80106b73:	8b 46 04             	mov    0x4(%esi),%eax
80106b76:	85 c0                	test   %eax,%eax
80106b78:	0f 84 c2 00 00 00    	je     80106c40 <switchuvm+0xf0>
  pushcli();
80106b7e:	e8 ed d8 ff ff       	call   80104470 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b83:	e8 48 cd ff ff       	call   801038d0 <mycpu>
80106b88:	89 c3                	mov    %eax,%ebx
80106b8a:	e8 41 cd ff ff       	call   801038d0 <mycpu>
80106b8f:	89 c7                	mov    %eax,%edi
80106b91:	e8 3a cd ff ff       	call   801038d0 <mycpu>
80106b96:	83 c7 08             	add    $0x8,%edi
80106b99:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b9c:	e8 2f cd ff ff       	call   801038d0 <mycpu>
80106ba1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106ba4:	ba 67 00 00 00       	mov    $0x67,%edx
80106ba9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106bb0:	83 c0 08             	add    $0x8,%eax
80106bb3:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106bba:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bbf:	83 c1 08             	add    $0x8,%ecx
80106bc2:	c1 e8 18             	shr    $0x18,%eax
80106bc5:	c1 e9 10             	shr    $0x10,%ecx
80106bc8:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106bce:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106bd4:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106bd9:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106be0:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106be5:	e8 e6 cc ff ff       	call   801038d0 <mycpu>
80106bea:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106bf1:	e8 da cc ff ff       	call   801038d0 <mycpu>
80106bf6:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106bfa:	8b 5e 08             	mov    0x8(%esi),%ebx
80106bfd:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c03:	e8 c8 cc ff ff       	call   801038d0 <mycpu>
80106c08:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c0b:	e8 c0 cc ff ff       	call   801038d0 <mycpu>
80106c10:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106c14:	b8 28 00 00 00       	mov    $0x28,%eax
80106c19:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106c1c:	8b 46 04             	mov    0x4(%esi),%eax
80106c1f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106c24:	0f 22 d8             	mov    %eax,%cr3
}
...
80106c2d:	5d                   	pop    %ebp
  popcli();
80106c2e:	e9 8d d8 ff ff       	jmp    801044c0 <popcli>
    panic("switchuvm: no process");
80106c33:	83 ec 0c             	sub    $0xc,%esp
80106c36:	68 d2 7a 10 80       	push   $0x80107ad2
80106c3b:	e8 50 97 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106c40:	83 ec 0c             	sub    $0xc,%esp
80106c43:	68 fd 7a 10 80       	push   $0x80107afd
80106c48:	e8 43 97 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106c4d:	83 ec 0c             	sub    $0xc,%esp
80106c50:	68 e8 7a 10 80       	push   $0x80107ae8
80106c55:	e8 36 97 ff ff       	call   80100390 <panic>
...
80106c70:	8b 75 10             	mov    0x10(%ebp),%esi
80106c73:	8b 7d 08             	mov    0x8(%ebp),%edi
80106c76:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106c79:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106c7f:	77 4b                	ja     80106ccc <inituvm+0x6c>
  mem = kalloc();
80106c81:	e8 aa b9 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106c86:	83 ec 04             	sub    $0x4,%esp
80106c89:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106c8e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106c90:	6a 00                	push   $0x0
80106c92:	50                   	push   %eax
80106c93:	e8 e8 d9 ff ff       	call   80104680 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106c98:	58                   	pop    %eax
80106c99:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106c9f:	5a                   	pop    %edx
80106ca0:	6a 06                	push   $0x6
80106ca2:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ca7:	31 d2                	xor    %edx,%edx
80106ca9:	50                   	push   %eax
80106caa:	89 f8                	mov    %edi,%eax
80106cac:	e8 af fc ff ff       	call   80106960 <mappages>
  memmove(mem, init, sz);
80106cb1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106cb4:	89 75 10             	mov    %esi,0x10(%ebp)
80106cb7:	83 c4 10             	add    $0x10,%esp
80106cba:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106cbd:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106cc6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cc7:	e9 54 da ff ff       	jmp    80104720 <memmove>
    panic("inituvm: more than a page");
80106ccc:	83 ec 0c             	sub    $0xc,%esp
80106ccf:	68 11 7b 10 80       	push   $0x80107b11
...
80106cf0:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106cf3:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106cf8:	0f 85 99 00 00 00    	jne    80106d97 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106cfe:	01 f0                	add    %esi,%eax
80106d00:	89 f3                	mov    %esi,%ebx
80106d02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106d05:	8b 45 14             	mov    0x14(%ebp),%eax
80106d08:	01 f0                	add    %esi,%eax
80106d0a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106d0d:	85 f6                	test   %esi,%esi
80106d0f:	75 15                	jne    80106d26 <loaduvm+0x46>
80106d11:	eb 6d                	jmp    80106d80 <loaduvm+0xa0>
80106d13:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106d17:	90                   	nop
80106d18:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106d1e:	89 f0                	mov    %esi,%eax
80106d20:	29 d8                	sub    %ebx,%eax
80106d22:	39 c6                	cmp    %eax,%esi
80106d24:	76 5a                	jbe    80106d80 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106d26:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d29:	8b 45 08             	mov    0x8(%ebp),%eax
80106d2c:	31 c9                	xor    %ecx,%ecx
80106d2e:	29 da                	sub    %ebx,%edx
80106d30:	e8 ab fb ff ff       	call   801068e0 <walkpgdir>
80106d35:	85 c0                	test   %eax,%eax
80106d37:	74 51                	je     80106d8a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
80106d5b:	ff 75 10             	pushl  0x10(%ebp)
80106d5e:	e8 fd ac ff ff       	call   80101a60 <readi>
80106d63:	83 c4 10             	add    $0x10,%esp
80106d66:	39 f8                	cmp    %edi,%eax
80106d68:	74 ae                	je     80106d18 <loaduvm+0x38>
}
...
80106d8d:	68 2b 7b 10 80       	push   $0x80107b2b
80106d92:	e8 f9 95 ff ff       	call   80100390 <panic>
    panic("loaduvm: addr must be page aligned");
80106d97:	83 ec 0c             	sub    $0xc,%esp
80106d9a:	68 cc 7b 10 80       	push   $0x80107bcc
80106d9f:	e8 ec 95 ff ff       	call   80100390 <panic>
80106da4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106dba:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106dbd:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106dc0:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106dc3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dc6:	85 c0                	test   %eax,%eax
80106dc8:	0f 88 b2 00 00 00    	js     80106e80 <allocuvm+0xd0>
  if(newsz < oldsz)
80106dce:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106dd1:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106dd4:	0f 82 96 00 00 00    	jb     80106e70 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106dda:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106de0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106de6:	39 75 10             	cmp    %esi,0x10(%ebp)
80106de9:	77 40                	ja     80106e2b <allocuvm+0x7b>
80106deb:	e9 83 00 00 00       	jmp    80106e73 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106df0:	83 ec 04             	sub    $0x4,%esp
80106df3:	68 00 10 00 00       	push   $0x1000
80106df8:	6a 00                	push   $0x0
80106dfa:	50                   	push   %eax
80106dfb:	e8 80 d8 ff ff       	call   80104680 <memset>
...
80106e14:	e8 47 fb ff ff       	call   80106960 <mappages>
...
80106e29:	76 48                	jbe    80106e73 <allocuvm+0xc3>
    mem = kalloc();
80106e2b:	e8 00 b8 ff ff       	call   80102630 <kalloc>
...
80106e39:	68 49 7b 10 80       	push   $0x80107b49
80106e3e:	e8 6d 98 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106e55:	e8 96 fb ff ff       	call   801069f0 <deallocuvm.part.0>
      return 0;
...
80106e9b:	68 61 7b 10 80       	push   $0x80107b61
80106ea0:	e8 0b 98 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106eb7:	e8 34 fb ff ff       	call   801069f0 <deallocuvm.part.0>
      kfree(mem);
80106ebc:	83 ec 0c             	sub    $0xc,%esp
80106ebf:	53                   	push   %ebx
80106ec0:	e8 ab b5 ff ff       	call   80102470 <kfree>
      return 0;
...
80106ee7:	8b 55 0c             	mov    0xc(%ebp),%edx
80106eea:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106eed:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80106ef0:	39 d1                	cmp    %edx,%ecx
80106ef2:	73 0c                	jae    80106f00 <deallocuvm+0x20>
}
80106ef4:	5d                   	pop    %ebp
80106ef5:	e9 f6 fa ff ff       	jmp    801069f0 <deallocuvm.part.0>
...
80106f1d:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  if(pgdir == 0)
80106f20:	85 f6                	test   %esi,%esi
80106f22:	74 55                	je     80106f79 <freevm+0x69>
  if(newsz >= oldsz)
80106f24:	31 c9                	xor    %ecx,%ecx
80106f26:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106f2b:	89 f0                	mov    %esi,%eax
80106f2d:	89 f3                	mov    %esi,%ebx
80106f2f:	e8 bc fa ff ff       	call   801069f0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106f34:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106f3a:	eb 0b                	jmp    80106f47 <freevm+0x37>
...
80106f5e:	e8 0d b5 ff ff       	call   80102470 <kfree>
...
80106f73:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106f74:	e9 f7 b4 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80106f79:	83 ec 0c             	sub    $0xc,%esp
80106f7c:	68 7d 7b 10 80       	push   $0x80107b7d
...
80106f98:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
80106f99:	e8 92 b6 ff ff       	call   80102630 <kalloc>
80106f9e:	89 c6                	mov    %eax,%esi
80106fa0:	85 c0                	test   %eax,%eax
80106fa2:	74 42                	je     80106fe6 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80106fa4:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106fa7:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106fac:	68 00 10 00 00       	push   $0x1000
80106fb1:	6a 00                	push   $0x0
80106fb3:	50                   	push   %eax
80106fb4:	e8 c7 d6 ff ff       	call   80104680 <memset>
80106fb9:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80106fbc:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106fbf:	83 ec 08             	sub    $0x8,%esp
80106fc2:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106fc5:	ff 73 0c             	pushl  0xc(%ebx)
80106fc8:	8b 13                	mov    (%ebx),%edx
80106fca:	50                   	push   %eax
80106fcb:	29 c1                	sub    %eax,%ecx
80106fcd:	89 f0                	mov    %esi,%eax
80106fcf:	e8 8c f9 ff ff       	call   80106960 <mappages>
80106fd4:	83 c4 10             	add    $0x10,%esp
80106fd7:	85 c0                	test   %eax,%eax
80106fd9:	78 15                	js     80106ff0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106fdb:	83 c3 10             	add    $0x10,%ebx
80106fde:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106fe4:	75 d6                	jne    80106fbc <setupkvm+0x2c>
}
80106fe6:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80107017:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010701a:	e8 71 ff ff ff       	call   80106f90 <setupkvm>
8010701f:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80107024:	05 00 00 00 80       	add    $0x80000000,%eax
80107029:	0f 22 d8             	mov    %eax,%cr3
}
8010702c:	c9                   	leave  
8010702d:	c3                   	ret    
...
80107042:	e8 99 f8 ff ff       	call   801068e0 <walkpgdir>
  if(pte == 0)
80107047:	85 c0                	test   %eax,%eax
80107049:	74 05                	je     80107050 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
8010704b:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010704e:	c9                   	leave  
8010704f:	c3                   	ret    
    panic("clearpteu");
80107050:	83 ec 0c             	sub    $0xc,%esp
80107053:	68 8e 7b 10 80       	push   $0x80107b8e
...
8010706a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
8010706d:	e8 1e ff ff ff       	call   80106f90 <setupkvm>
80107072:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107075:	85 c0                	test   %eax,%eax
80107077:	0f 84 9b 00 00 00    	je     80107118 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010707d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107080:	85 c9                	test   %ecx,%ecx
80107082:	0f 84 90 00 00 00    	je     80107118 <copyuvm+0xb8>
80107088:	31 f6                	xor    %esi,%esi
8010708a:	eb 46                	jmp    801070d2 <copyuvm+0x72>
...
80107109:	e8 02 fe ff ff       	call   80106f10 <freevm>
  return 0;
8010710e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107121:	5d                   	pop    %ebp
80107122:	c3                   	ret    
80107123:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107127:	90                   	nop
      kfree(mem);
80107128:	83 ec 0c             	sub    $0xc,%esp
8010712b:	53                   	push   %ebx
8010712c:	e8 3f b3 ff ff       	call   80102470 <kfree>
      goto bad;
80107131:	83 c4 10             	add    $0x10,%esp
80107134:	eb cd                	jmp    80107103 <copyuvm+0xa3>
      panic("copyuvm: page not present");
80107136:	83 ec 0c             	sub    $0xc,%esp
80107139:	68 b2 7b 10 80       	push   $0x80107bb2
8010713e:	e8 4d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107143:	83 ec 0c             	sub    $0xc,%esp
80107146:	68 98 7b 10 80       	push   $0x80107b98
...
80107162:	e8 79 f7 ff ff       	call   801068e0 <walkpgdir>
  if((*pte & PTE_P) == 0)
80107167:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
8010716a:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010716c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107171:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107174:	05 00 00 00 80       	add    $0x80000000,%eax
80107179:	83 fa 05             	cmp    $0x5,%edx
8010717c:	ba 00 00 00 00       	mov    $0x0,%edx
80107181:	0f 45 c2             	cmovne %edx,%eax
}
80107184:	c3                   	ret    
...
8010719d:	8b 75 14             	mov    0x14(%ebp),%esi
801071a0:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
801071a3:	85 f6                	test   %esi,%esi
801071a5:	75 3c                	jne    801071e3 <copyout+0x53>
801071a7:	eb 67                	jmp    80107210 <copyout+0x80>
...
801071b5:	29 d3                	sub    %edx,%ebx
801071b7:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801071bd:	39 f3                	cmp    %esi,%ebx
801071bf:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801071c2:	29 fa                	sub    %edi,%edx
801071c4:	83 ec 04             	sub    $0x4,%esp
801071c7:	01 c2                	add    %eax,%edx
801071c9:	53                   	push   %ebx
801071ca:	ff 75 10             	pushl  0x10(%ebp)
801071cd:	52                   	push   %edx
801071ce:	e8 4d d5 ff ff       	call   80104720 <memmove>
    len -= n;
    buf += n;
801071d3:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
801071d6:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
801071dc:	83 c4 10             	add    $0x10,%esp
801071df:	29 de                	sub    %ebx,%esi
801071e1:	74 2d                	je     80107210 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
801071e3:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801071e5:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
801071e8:	89 55 0c             	mov    %edx,0xc(%ebp)
801071eb:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
801071f1:	57                   	push   %edi
801071f2:	ff 75 08             	pushl  0x8(%ebp)
801071f5:	e8 56 ff ff ff       	call   80107150 <uva2ka>
    if(pa0 == 0)
801071fa:	83 c4 10             	add    $0x10,%esp
801071fd:	85 c0                	test   %eax,%eax
801071ff:	75 af                	jne    801071b0 <copyout+0x20>
  }
  return 0;
}
80107201:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80107204:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107209:	5b                   	pop    %ebx
8010720a:	5e                   	pop    %esi
8010720b:	5f                   	pop    %edi
