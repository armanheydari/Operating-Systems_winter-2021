...
_userTestProcDump:     file format elf32-i386
...
int main(int argc, char* argv[]) {
  ...
  1e:	e8 5d 03 00 00       	call   380 <atoi>
	int pids[process_number];
  23:	83 c4 10             	add    $0x10,%esp
  26:	8d 14 85 0f 00 00 00 	lea    0xf(,%eax,4),%edx
	int process_number = atoi(argv[1]), len, i;
  2d:	89 c6                	mov    %eax,%esi
	int pids[process_number];
  2f:	89 e1                	mov    %esp,%ecx
  31:	89 d0                	mov    %edx,%eax
  33:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  39:	29 d1                	sub    %edx,%ecx
  3b:	83 e0 f0             	and    $0xfffffff0,%eax
  3e:	89 ca                	mov    %ecx,%edx
  40:	39 d4                	cmp    %edx,%esp
  42:	74 12                	je     56 <main+0x56>
  44:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  4a:	83 8c 24 fc 0f 00 00 	orl    $0x0,0xffc(%esp)
  51:	00 
  52:	39 d4                	cmp    %edx,%esp
  54:	75 ee                	jne    44 <main+0x44>
  56:	25 ff 0f 00 00       	and    $0xfff,%eax
  5b:	29 c4                	sub    %eax,%esp
  5d:	85 c0                	test   %eax,%eax
  5f:	0f 85 d1 00 00 00    	jne    136 <main+0x136>
  65:	89 65 d4             	mov    %esp,-0x2c(%ebp)
	struct proc_info *procs = NULL;
	
	for (i = 0; i<process_number; i++) {
  68:	85 f6                	test   %esi,%esi
  6a:	0f 8e d0 00 00 00    	jle    140 <main+0x140>
  70:	31 db                	xor    %ebx,%ebx
  72:	eb 04                	jmp    78 <main+0x78>
  74:	39 f3                	cmp    %esi,%ebx
  76:	74 32                	je     aa <main+0xaa>
		pids[i] = fork();
  78:	e8 6e 03 00 00       	call   3eb <fork>
  7d:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
  80:	89 04 99             	mov    %eax,(%ecx,%ebx,4)
		if (pids[i] == 0) {
  83:	83 c3 01             	add    $0x1,%ebx
  86:	85 c0                	test   %eax,%eax
  88:	75 ea                	jne    74 <main+0x74>
			char *temp = malloc(sizeof(char) * (i+1) * 45000);
  8a:	69 db c8 af 00 00    	imul   $0xafc8,%ebx,%ebx
  90:	83 ec 0c             	sub    $0xc,%esp
  93:	53                   	push   %ebx
  94:	e8 17 07 00 00       	call   7b0 <malloc>
			memset(temp, 10, sizeof(char) * (i+1) * 45000);
  99:	83 c4 0c             	add    $0xc,%esp
  9c:	53                   	push   %ebx
  9d:	6a 0a                	push   $0xa
  9f:	50                   	push   %eax
  a0:	e8 ab 01 00 00       	call   250 <memset>
  a5:	83 c4 10             	add    $0x10,%esp
			while(1);
  a8:	eb fe                	jmp    a8 <main+0xa8>
			exit();
		}
	}
  ...
  ad:	6a 64                	push   $0x64
  af:	e8 cf 03 00 00       	call   483 <sleep>

	procs = malloc(sizeof(struct proc_info) * NPROC);
  b4:	c7 04 24 00 02 00 00 	movl   $0x200,(%esp)
  bb:	e8 f0 06 00 00       	call   7b0 <malloc>
  ...
  c7:	50                   	push   %eax
  c8:	53                   	push   %ebx
  c9:	e8 c5 03 00 00       	call   493 <proc_dump>
	
	printf(1, "pid\tmemory size\n");
  ce:	59                   	pop    %ecx
  cf:	5f                   	pop    %edi
  d0:	68 bf 08 00 00       	push   $0x8bf
  d5:	6a 01                	push   $0x1
  d7:	e8 74 04 00 00       	call   550 <printf>
	for(i=0; i<len; i++){
  dc:	83 c4 10             	add    $0x10,%esp
  df:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  e3:	7e 24                	jle    109 <main+0x109>
  e5:	31 ff                	xor    %edi,%edi
		printf(1, "%d\t%d\n", procs[i].pid, procs[i].memsize);
  e7:	ff 74 fb 04          	pushl  0x4(%ebx,%edi,8)
  eb:	ff 34 fb             	pushl  (%ebx,%edi,8)
	for(i=0; i<len; i++){
  ee:	83 c7 01             	add    $0x1,%edi
		printf(1, "%d\t%d\n", procs[i].pid, procs[i].memsize);
  f1:	68 b8 08 00 00       	push   $0x8b8
  f6:	6a 01                	push   $0x1
  f8:	e8 53 04 00 00       	call   550 <printf>
	for(i=0; i<len; i++){
  fd:	83 c4 10             	add    $0x10,%esp
 100:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
 103:	7f e2                	jg     e7 <main+0xe7>
	}

	for(i=0; i < process_number; i++){
 105:	85 f6                	test   %esi,%esi
 107:	7e 1f                	jle    128 <main+0x128>
	for(i=0; i<len; i++){
 109:	31 ff                	xor    %edi,%edi
		wait();
 10b:	e8 eb 02 00 00       	call   3fb <wait>
		kill(pids[i]);
 110:	8b 45 d4             	mov    -0x2c(%ebp),%eax
 113:	83 ec 0c             	sub    $0xc,%esp
 116:	ff 34 b8             	pushl  (%eax,%edi,4)
	for(i=0; i < process_number; i++){
 119:	83 c7 01             	add    $0x1,%edi
		kill(pids[i]);
 11c:	e8 02 03 00 00       	call   423 <kill>
	for(i=0; i < process_number; i++){
 121:	83 c4 10             	add    $0x10,%esp
 124:	39 fe                	cmp    %edi,%esi
 126:	75 e3                	jne    10b <main+0x10b>
	}
	free(procs);
 128:	83 ec 0c             	sub    $0xc,%esp
 12b:	53                   	push   %ebx
 12c:	e8 ef 05 00 00       	call   720 <free>
	exit();
 131:	e8 bd 02 00 00       	call   3f3 <exit>
	int pids[process_number];
 136:	83 4c 04 fc 00       	orl    $0x0,-0x4(%esp,%eax,1)
 13b:	e9 25 ff ff ff       	jmp    65 <main+0x65>
	sleep(100);
 140:	83 ec 0c             	sub    $0xc,%esp
 143:	6a 64                	push   $0x64
 145:	e8 39 03 00 00       	call   483 <sleep>
	procs = malloc(sizeof(struct proc_info) * NPROC);
 14a:	c7 04 24 00 02 00 00 	movl   $0x200,(%esp)
 151:	e8 5a 06 00 00       	call   7b0 <malloc>
 156:	89 c3                	mov    %eax,%ebx
	proc_dump(procs, &len);
 158:	58                   	pop    %eax
 159:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 15c:	5a                   	pop    %edx
 15d:	50                   	push   %eax
 15e:	53                   	push   %ebx
 15f:	e8 2f 03 00 00       	call   493 <proc_dump>
	printf(1, "pid\tmemory size\n");
 164:	59                   	pop    %ecx
 165:	5f                   	pop    %edi
 166:	68 bf 08 00 00       	push   $0x8bf
 16b:	6a 01                	push   $0x1
 16d:	e8 de 03 00 00       	call   550 <printf>
	for(i=0; i<len; i++){
 172:	83 c4 10             	add    $0x10,%esp
 175:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
 179:	0f 8f 66 ff ff ff    	jg     e5 <main+0xe5>
 17f:	eb a7                	jmp    128 <main+0x128>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	eb 1a                	jmp    6f0 <printf+0x1a0>
          s = "(null)";
 6d6:	bb d0 08 00 00       	mov    $0x8d0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 725:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 746:	73 10                	jae    758 <free+0x38>
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 777:	5e                   	pop    %esi
 778:	5f                   	pop    %edi
 779:	5d                   	pop    %ebp
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7c0:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 809:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 832:	e8 e9 fe ff ff       	call   720 <free>
  return freep;
 837:	a1 8c 0b 00 00       	mov    0xb8c,%eax
 ...
 864:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 867:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 ...
 87e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 880:	c7 05 8c 0b 00 00 90 	movl   $0xb90,0xb8c
 887:	0b 00 00 
    base.s.size = 0;
 88a:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 88f:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 896:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 899:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 89b:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 8a2:	00 00 00 
    if(p->s.size >= nunits){
